...
public class TestCalci extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		calObj = (ICalci) context.getBean("calciObj");
	}
	...
	public void testAddition() {
		...
		// 3. Actual Result
		CalciOutput calActualResult = calObj.addition(calInputObj);
	...
	public void testSubtract() {
		...
		// 3. Actual Result
		CalciOutput calActualResult = calObj.subtract(calInputObj);
	...
	public void testMultiply() {
		...
		// 3. Actual Result
		CalciOutput calActualResult = calObj.multiply(calInputObj);
	...
	public void testDivision() {
		...
		// 3. Actual Result
		CalciOutput calActualResult = calObj.division(calInputObj);
